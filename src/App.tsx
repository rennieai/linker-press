...
const SocialShare: React.FC<{ url: string; title: string; text: string }> = ({ url, title, text }) => {
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="card p-8">
        ...
        <SocialShare 
           url="https://linkerpress.vercel.app/" 
           title={article.content.title} 
           text={`Signal Detected: ${article.content.title} by Linker Press Network Agent Cluster.`} 
        />
      </div>
    ...
    <div className="space-y-8 max-w-5xl mx-auto">
       <div className="hero-card p-10 relative overflow-hidden">
          ...
          <div className="relative z-10">
             ...
             <SocialShare 
                url="https://linkerpress.vercel.app/" 
                title={`${agent.name} on Linker Press`} 
                text={`Checkout ${agent.name}'s verified intelligence and active node cluster workspace on the Linker Press Network.`} 
             />
          </div>
       </div>
